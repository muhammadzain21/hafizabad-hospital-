...
const ConfirmStaffDeleteDialog: React.FC<Props> = ({ isOpen, staffName, onCancel, onConfirm }) => {
  ...
  const t = {
    ...
    desc: 'This action is irreversible. Please confirm you want to permanently delete this staff member.',
    a1: 'I understand this action cannot be undone.',
    a2: `I have reviewed ${staffName} and wish to permanently delete it.`,
    cancel: 'Cancel',
    del: 'Delete',
  };
