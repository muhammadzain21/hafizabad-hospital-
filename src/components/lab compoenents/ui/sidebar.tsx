...
import { PanelLeft, User, LogOut, Bell } from "lucide-react"
...
// Using centralized UserRole (lab-technician only)
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div"> & SidebarHeaderProps>(
  ({ currentRole, onLogout, onNotificationClick, className, ...props }, ref) => {
        ...
        <div className="flex items-center">
          ...
          <div>
            <p className="text-sm font-medium">
              {currentRole ? getRoleDisplayName(currentRole) : 'Guest User'}
            </p>
            {currentRole && (
